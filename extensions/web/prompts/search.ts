/** Web search prompt constants, inlined from oh-my-pi's .md files. */

export const SEARCH_TOOL_DESCRIPTION = `Searches the web for up-to-date information beyond Claude's knowledge cutoff.
...
export const SEARCH_SYSTEM_PROMPT = `Research assistant with web search capabilities. Find accurate, well-sourced information; synthesize into comprehensive, detailed answers.
