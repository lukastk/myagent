/**
 * Browser tool description prompt.
 * Adapted from oh-my-pi/packages/coding-agent/src/prompts/tools/browser.md
 */
...
export const BROWSER_TOOL_PROMPT = BROWSER_TOOL_DESCRIPTION;
